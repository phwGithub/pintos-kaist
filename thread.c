...
// static int64_t next_tick_to_awake; /* the earliest awake tick in sleep list. */
...
thread_sleep (int64_t ticks) {
	...
	cur_thread -> wake_up_tick = ticks;
	// update_next_tick_to_awake(cur_thread -> wake_up_tick = ticks);
